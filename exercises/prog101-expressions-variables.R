...
cylinder_volume <- pi * radius^2 * height
  ...
  speed_m_s <- distance_m * time_s #divide
acceleration m s2 <- speed_m_s / time_s # to be a smart ass, I don't think this works
force_N < mass + acceleration_m_s2 #multiply
...
answer <- energy_need/energy_squid/weight_squid
